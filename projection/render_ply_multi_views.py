...
raster_settings = PointsRasterizationSettings(
    ...
    radius=0.005,
    points_per_pixel=30,  # 각 픽셀당 가장 가까운 100개 포인트
)
...
np.save(os.path.join(output_dir, "point_index_map_all.npy"), all_point_indices)
print("Saved all point index maps to point_index_map_all.npy")